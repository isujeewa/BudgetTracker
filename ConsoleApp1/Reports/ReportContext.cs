...
namespace ExpenseTrackingApp.Reports
{
    public class ReportContext
    {
        ...
        public ReportContext(ReportStrategy reportStrategy , List<Item> incomeItems , List<Item> expensetems , List<Item> budgetIncomeItems, List<Item> budgetExpensetems)
        {
